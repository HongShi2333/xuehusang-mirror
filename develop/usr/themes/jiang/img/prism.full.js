        ...
        matchGrammar: function(text, strarr, grammar, index, startPos, oneshot, target) {
            ...
            for (var token in grammar) {
                ...
                for (var j = 0; j < patterns.length; ++j) {
                    ...
                    for (var i = index,
                    pos = startPos; i < strarr.length; pos += strarr[i].length, ++i) {
...
Prism.languages.dotnet = Prism.languages.csharp; (function(Prism) {
...
} (Prism));Prism.languages['markup-templating'] = {};
...
Prism.languages.insertBefore('less', 'property', {
	...
	'mixin-usage': {
		pattern: / ([{;]\s * )[.#]( ? !\d)[\w - ] + . * ?( ? =[(;]) / , lookbehind: true, alias: 'function'
    }
});
...
(function(Prism) {
    ...
    Prism.hooks.add('before-tokenize',
    function(env) {
...
(function(Prism) {
    ...
    function(env) {
        ...
        Prism.languages['markup-templating'].buildPlaceholders(env, 'smarty', smartyPattern,
        function(match) {
